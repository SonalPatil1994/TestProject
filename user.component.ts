...
export class UserComponent implements OnInit {
    ...
    users: IUser[];
    selectedUsers: IUser[];// for product it will be selectedProducts:IProduct
    user: IUser;
    msg: string;
    ...
    purchaseItems() {
        // currentUser is already login, so we retrieve cureentUserId first
        var currentUser = JSON.parse(sessionStorage.getItem("currentUser"));
        //check if this user has ashoppong cart already
